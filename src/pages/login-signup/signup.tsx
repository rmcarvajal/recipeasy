    ...
    <div className="bg-smoke flex flex-col items-center lg:flex-row-reverse min-h-screen">
        ...
        <div className="flex flex-col items-center lg:w-1/2 w-full px-4 py-8 lg:py-0">
            ...
            <div className="w-full max-w-md drop-shadow-2xl bg-white p-6 sm:p-10 rounded-[20px] ">
                ...
                <div className="pb-5">
                <h1 className="text-[28px] sm:text-[38px] font-extrabold text-charcoal-500">Create Account</h1>
                <p className="text-[16px] sm:text-[20px] text-charcoal-100">Join thousands of home cooks today!</p>
                </div>
                ...
                <button className="bg-forest text-white w-full max-w-[320px] h-[60px] sm:h-[77.5px] font-extrabold rounded-[18px] text-[20px] sm:text-[24px]" onClick={Register}>Create Account</button>
            </div>
